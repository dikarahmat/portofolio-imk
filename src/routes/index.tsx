...
// DESKRIPSI: Halaman utama portofolio Dika Rahmat Fadillah
// ROUTE: / (root)
// ============================================================
  ...
  head: () => ({
    meta: [
      { title: "Portofolio — Mahasiswa IMK" },
      {
        name: "description",
        content:
          "Portofolio pribadi berbasis prinsip Interaksi Manusia dan Komputer (IMK).",
      },
      { property: "og:title", content: "Portofolio — Mahasiswa IMK" },
      {
        property: "og:description",
        content:
          "Portofolio pribadi berbasis prinsip Interaksi Manusia dan Komputer.",
      },
    ],
    links: [
...
// ─── Data Teknologi (untuk modal skill) ──────────────────────
const TECH_INFO: Record<
  string,
  { desc: string; use: string; color: string; textColor: string; icon: string }
> = {
  HTML: {
    color: "#E34F26",
    textColor: "#fff",
    icon: "html5/ffffff",
    desc: "HyperText Markup Language — bahasa markup dasar untuk membuat struktur halaman web.",
    use: "Digunakan untuk membuat kerangka/struktur konten di setiap halaman website.",
  },
  JavaScript: {
    color: "#F7DF1E",
    textColor: "#1a1a1a",
    icon: "javascript/1a1a1a",
    desc: "Bahasa pemrograman yang berjalan di browser untuk membuat halaman web menjadi interaktif.",
    use: "Digunakan untuk animasi, validasi form, fetch data dari API, dan logika frontend.",
  },
  "Node JS": {
    color: "#339933",
    textColor: "#fff",
    icon: "nodedotjs/ffffff",
    desc: "Runtime JavaScript di sisi server yang memungkinkan JS berjalan di luar browser.",
    use: "Digunakan untuk membuat backend/server, REST API, dan tools development.",
  },
  "Tailwind CSS": {
    color: "#06B6D4",
    textColor: "#fff",
    icon: "tailwindcss/ffffff",
    desc: "Framework CSS berbasis utility-class yang mempercepat styling langsung di HTML.",
    use: "Digunakan untuk styling cepat tanpa menulis CSS manual, sangat populer di React.",
  },
  ReactJS: {
    color: "#20232A",
    textColor: "#61DAFB",
    icon: "react/61DAFB",
    desc: "Library JavaScript buatan Meta untuk membangun antarmuka pengguna berbasis komponen.",
    use: "Digunakan untuk membuat UI yang dinamis, reusable, dan mudah di-maintain.",
  },
  Vite: {
    color: "#646CFF",
    textColor: "#fff",
    icon: "vite/ffffff",
    desc: "Build tool generasi terbaru yang sangat cepat untuk project frontend modern.",
    use: "Digunakan sebagai pengganti Webpack, mempercepat development server dan build production.",
  },
  CSS: {
    color: "#1572B6",
    textColor: "#fff",
    icon: "css3/ffffff",
    desc: "Cascading Style Sheets — bahasa untuk mengatur tampilan dan gaya halaman HTML.",
    use: "Digunakan untuk mengatur warna, font, layout, animasi, dan responsivitas halaman.",
  },
  Bootstrap: {
    color: "#7952B3",
    textColor: "#fff",
    icon: "bootstrap/ffffff",
    desc: "Framework CSS populer dengan komponen UI siap pakai seperti tombol, navbar, grid.",
    use: "Digunakan untuk membangun tampilan web responsif dengan cepat tanpa banyak CSS custom.",
  },
  Firebase: {
    color: "#FFCA28",
    textColor: "#1a1a1a",
    icon: "firebase/1a1a1a",
    desc: "Platform Backend-as-a-Service dari Google dengan database realtime, auth, dan hosting.",
    use: "Digunakan untuk autentikasi user, penyimpanan data realtime, dan deploy aplikasi web.",
  },
  "Material UI": {
    color: "#007FFF",
    textColor: "#fff",
    icon: "mui/ffffff",
    desc: "Library komponen React yang mengikuti panduan desain Material Design dari Google.",
    use: "Digunakan untuk membuat UI yang konsisten dan profesional dengan komponen siap pakai.",
  },
  Vercel: {
    color: "#000000",
    textColor: "#fff",
    icon: "vercel/ffffff",
    desc: "Platform cloud untuk deploy dan hosting aplikasi frontend, terutama Next.js dan React.",
    use: "Digunakan untuk deploy project secara instan dengan integrasi GitHub dan CDN global.",
  },
  SweetAlert2: {
    color: "#FF7043",
    textColor: "#fff",
    icon: "sweetalert2/ffffff",
    desc: "Library JavaScript untuk membuat dialog/popup/alert yang cantik dan customizable.",
    use: "Digunakan sebagai pengganti alert bawaan browser dengan tampilan yang lebih menarik.",
  },
};

// ─── Kartu Keahlian (About Section) ──────────────────────────
const ABOUT_CARDS = [
  {
    t: "UI Design",
    color: "#7C3AED",
    lightColor: "#EDE9FE",
    desc: "Merancang tampilan visual yang intuitif, estetis, dan berpusat pada pengguna — dari warna, tipografi, hingga layout yang konsisten.",
  },
  {
    t: "Front-end",
    color: "#0EA5E9",
    lightColor: "#E0F2FE",
    desc: "Membangun antarmuka web yang responsif dan interaktif menggunakan React, Tailwind CSS, dan teknologi modern lainnya.",
  },
  {
    t: "Prototyping",
    color: "#F59E0B",
    lightColor: "#FEF3C7",
    desc: "Membuat prototipe interaktif di Figma untuk menguji alur dan pengalaman pengguna sebelum masuk ke tahap development.",
  },
  {
    t: "Research",
    color: "#10B981",
    lightColor: "#D1FAE5",
    desc: "Melakukan riset pengguna, analisis kebutuhan, dan usability testing agar produk benar-benar sesuai kebutuhan.",
  },
];
...
const EDUCATION = [
  ...
  },
  {
    y: "2021 — 2024",
    s: "SMA — Jurusan IPA",
    i: "SMA Negeri 1 Sendang Agung",
    color: "#0EA5E9",
  },
  {
    y: "2018 — 2021",
    s: "SMP",
    i: "SMP Negeri 2 Sendang Agung",
    color: "#F59E0B",
  },
];
...
// ─── Data Skill Utama (kiri & kanan Hero Skills) ──────────────
const SKILLS_LEFT = [
...
// ─── SkillPill: Tombol pill untuk satu teknologi ──────────────
function SkillPill({
  item,
  style,
  onClick,
  ...
  return (
    <div
      ...
      onClick={() => onClick(item.n)}
      onMouseEnter={(e) => {
        const el = e.currentTarget as HTMLElement;
        el.style.backgroundColor = item.hoverBg;
        el.style.color = item.hoverText;
        el.style.borderColor = item.hoverBg;
      }}
      onMouseLeave={(e) => {
        const el = e.currentTarget as HTMLElement;
    ...
    >
      ...
      >
        <img
          src={`https://cdn.simpleicons.org/${item.s}/${item.c}`}
          alt={item.n}
          className="h-4 w-4"
          loading="lazy"
        />
...
// ─── AboutModal: Modal popup untuk kartu keahlian ────────────
function AboutModal({
  activeAbout,
  onClose,
}: {
...
// ─── SkillModal: Modal popup untuk detail teknologi ───────────
function SkillModal({
  activeSkill,
  onClose,
}: {
    ...
    >
      ...
      >
        ...
        <div className="mb-4 flex items-center gap-3">
          ...
          <h3 className="font-display text-2xl" style={{ color: txtColor }}>
            {activeSkill}
          </h3>
        </div>
        ...
        <p
          ...
          style={{ color: txtColor, opacity: 0.92 }}
        >
          {info?.desc}
        </p>
...
function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 md:px-6 md:py-4">
          ...
          <a href="#" className="-my-3 md:-my-6">
            <img src={logo} alt="Logo DK" className="h-13 w-auto md:h-17" />
          </a>
          ...
          <div className="relative z-10 mt-[-40px] md:mt-[-50px] lg:mt-[-60px]">
            <div className="relative mx-auto flex justify-center">
              <img
                ...
                style={{
                  filter:
                    "drop-shadow(0 30px 40px oklch(0.18 0.01 240 / 0.18))",
                }}
              />
            </div>

            {/* Badge "Tersedia" — desktop only */}
            ...
            {/* Teks deskripsi singkat — desktop only */}
            <div className="absolute bottom-12 left-8 z-20 hidden max-w-[200px] text-xs text-foreground/70 md:block">
              Mahasiswa{" "}
              <strong className="text-foreground">Teknik Informatika</strong>{" "}
              yang fokus pada front-end dan desain UI berlandaskan IMK.
            </div>
      ...
      {/* ======================================================
          SECTION: MARQUEE (Scroll teknologi)
          ====================================================== */}
      <div className="w-full overflow-hidden border-y border-border bg-background py-3 md:py-4">
        ...
        >
          {[
            ...
            <span
              key={i}
              className="italic-display whitespace-nowrap text-lg md:text-xl text-muted-foreground"
            >
              {t}
            </span>
          ))}
      ...
      {/* ======================================================
          ...
          ====================================================== */}
      <section id="about" className="px-6 pt-10 pb-6">
        <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-[1fr_1.5fr] md:items-center">
          <div>
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Saya seorang mahasiswa yang antusias dalam dunia desain dan
            teknologi. Berfokus pada perpaduan antara{" "}
            <span className="text-foreground">
              strategi yang jelas, desain yang rapi, dan empati terhadap
              pengguna
            </span>{" "}
        ...
        {/* Kartu keahlian */}
        <div className="mx-auto mt-5 grid max-w-5xl grid-cols-2 gap-4 md:grid-cols-4">
              ...
              >
                <div className="flex items-center gap-3 p-4">
                  <span
                    ...
                    style={{
                      backgroundColor: isHovered ? color : "var(--lime)",
                    }}
                  >
      ...
      {/* ======================================================
          SECTION: SKILLS (Teknologi)
          ====================================================== */}
      <section
        id="skills"
        className="relative overflow-hidden bg-background px-6 pt-2 pb-6 md:pt-8 md:pb-28"
      >
        {/* Layout mobile — hanya teks */}
        ...
        {/* Baris bawah — skill tambahan (desktop only) */}
        <div className="mx-auto mt-16 hidden max-w-5xl flex-wrap justify-center gap-3 md:flex">
          {SKILLS_BOTTOM.map((item) => (
            <SkillPill key={item.n} item={item} onClick={setActiveSkill} />
          ))}
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-4 max-w-xs text-sm text-muted-foreground md:mt-6 md:max-w-xl md:text-base">
            Terbuka untuk kolaborasi proyek dan diskusi seputar desain &amp;
            teknologi.
          </p>
      ...
      <footer className="border-t border-border bg-background px-6 py-8 md:py-10">
        ...
        {/* Nama besar di bawah footer (desktop only) */}
      ...
      {/* ======================================================
          MODAL: About (popup kartu keahlian)
          ====================================================== */}
      {activeAbout && (
        <AboutModal
          activeAbout={activeAbout}
          onClose={() => setActiveAbout(null)}
        />
      )}

      {/* ======================================================
          MODAL: Skill (popup detail teknologi)
          ====================================================== */}
      {activeSkill && (
        <SkillModal
